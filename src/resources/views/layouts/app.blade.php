    ...
    <body class="w3-light-grey">
        <div class="w3-top">
          <div class="w3-bar w3-black w3-card">
            ...
            <a href="../elshop" class="w3-bar-item w3-button w3-padding-large">ELSHOP</a>
            ...
            @auth
                <a href="{{ route('logout') }}" class="w3-padding-large w3-hover-red w3-hide-small w3-right" style="text-decoration: none"><i class="fa fa-lock"></i> LOGOUT</a>
                <a href="#" class="w3-padding-large w3-hover-red w3-hide-small w3-right" style="text-decoration: none"><i class="fa fa-user"></i> {{ Auth::user()->first_name }} {{ Auth::user()->last_name }}</a>
            @endauth
            @guest
